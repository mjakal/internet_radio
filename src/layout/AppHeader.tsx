...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-99999 flex h-16 w-full border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900">
      <div className="flex w-full flex-row items-center px-6">
